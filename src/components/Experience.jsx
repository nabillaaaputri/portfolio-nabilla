...
const EXPERIENCES = [
  {
    ...
    description: 'Supported the Planning and Program Evaluation Division through data management, data validation, and maintaining information in a web-based system to ensure reporting processes were accurate and well organized.',
  ...
  },
  {
    ...
    description: 'Completed frontend development training by building responsive user interfaces for the SiDoku web application using React and collaborating with a multidisciplinary team on a functional full-stack product experience.',
  ...
  },
  {
    ...
    description: 'Managed internal documentation, coordinated departmental activities, and supported communication and data handling workflows within the organization.',
